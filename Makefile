...
ACLOCAL = ${SHELL} /opt/RADIOCOIN-DIFF-gfx/radioCOIN/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /opt/RADIOCOIN-DIFF-gfx/radioCOIN/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /opt/RADIOCOIN-DIFF-gfx/radioCOIN/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /opt/RADIOCOIN-DIFF-gfx/radioCOIN/build-aux/missing automake-1.16
AWK = gawk
...
MAINT = 
MAKEINFO = ${SHELL} /opt/RADIOCOIN-DIFF-gfx/radioCOIN/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq 
abs_builddir = /opt/RADIOCOIN-DIFF-gfx/radioCOIN
abs_srcdir = /opt/RADIOCOIN-DIFF-gfx/radioCOIN
abs_top_builddir = /opt/RADIOCOIN-DIFF-gfx/radioCOIN
abs_top_srcdir = /opt/RADIOCOIN-DIFF-gfx/radioCOIN
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /opt/RADIOCOIN-DIFF-gfx/radioCOIN/build-aux/install-sh
