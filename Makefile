...
ACLOCAL = ${SHELL} /opt/RADIO/CURRENT/radiocoin/build-aux/missing aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
ARFLAGS = cr
AUTOCONF = ${SHELL} /opt/RADIO/CURRENT/radiocoin/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /opt/RADIO/CURRENT/radiocoin/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /opt/RADIO/CURRENT/radiocoin/build-aux/missing automake-1.16
...
MAINT = 
MAKEINFO = ${SHELL} /opt/RADIO/CURRENT/radiocoin/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq 
abs_builddir = /opt/RADIO/CURRENT/radiocoin
abs_srcdir = /opt/RADIO/CURRENT/radiocoin
abs_top_builddir = /opt/RADIO/CURRENT/radiocoin
abs_top_srcdir = /opt/RADIO/CURRENT/radiocoin
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /opt/RADIO/CURRENT/radiocoin/build-aux/install-sh
