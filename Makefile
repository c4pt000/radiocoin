...
ACLOCAL = ${SHELL} /opt/radio/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /opt/radio/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /opt/radio/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /opt/radio/build-aux/missing automake-1.15
AWK = gawk
...
LUPDATE = 
MAINT = 
MAKEINFO = ${SHELL} /opt/radio/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq 
abs_builddir = /opt/radio
abs_srcdir = /opt/radio
abs_top_builddir = /opt/radio
abs_top_srcdir = /opt/radio
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /opt/radio/build-aux/install-sh
