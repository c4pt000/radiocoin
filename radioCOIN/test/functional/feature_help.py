...
"""Verify that starting radiocoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start radiocoin with -h for help text")
        ...
        self.log.info("Start radiocoin with -version for version information")
        ...
        self.log.info("Start radiocoind with -fakearg to make sure it does not start")
