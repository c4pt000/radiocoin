...
Radio Coin is now available at `./src/dogecoind`

Before running, it's recommended you create an RPC configuration file.

    echo -e "rpcuser=dogecoinrpc\nrpcpassword=$(xxd -l 16 -p /dev/urandom)" > "/Users/${USER}/Library/Application Support/Radiocoin/dogecoin.conf"

    chmod 600 "/Users/${USER}/Library/Application Support/Radiocoin/dogecoin.conf"
