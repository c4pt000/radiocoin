...
*Setup instructions for a Gitian build of Radio Coin using a Debian VM or physical system.*
...
- [Building Radio Coin](#building-dogecoin-core)
...
To build Radio Coin (for Linux, OS X and Windows) just follow the steps under 'perform
