Radio Coin version 1.14.2 is now available from:
...
Radio Coin is extensively tested on Ubuntu Server LTS, Mac OS X and Windows 10.
...
Radio Coin should also work on most other Unix-like systems but is not
...
Radio Coin introduces pruning the blockchain in 1.14. Pruning
...
When Radio Coin is out-of-sync on startup, a semi-transparent information
...
----------------------
 ...
 - A new RPC command `getmemoryinfo` has been added which will return information
   about the memory usage of Radio Coin. This was added in conjunction with
