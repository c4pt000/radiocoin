...
!define MUI_ICON "/opt/CURRENTRADIO/share/pixmaps/bitcoin.ico"
!define MUI_WELCOMEFINISHPAGE_BITMAP "/opt/CURRENTRADIO/share/pixmaps/nsis-wizard.bmp"
!define MUI_HEADERIMAGE
!define MUI_HEADERIMAGE_RIGHT
!define MUI_HEADERIMAGE_BITMAP "/opt/CURRENTRADIO/share/pixmaps/nsis-header.bmp"
...
!define MUI_UNWELCOMEFINISHPAGE_BITMAP "/opt/CURRENTRADIO/share/pixmaps/nsis-wizard.bmp"
...
OutFile /opt/CURRENTRADIO/radiocoin-${VERSION}-win-setup.exe
!if "" == "64"
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File /opt/CURRENTRADIO/release/radiocoin-qt
    File /oname=COPYING.txt /opt/CURRENTRADIO/COPYING
    File /oname=readme.txt /opt/CURRENTRADIO/doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File /opt/CURRENTRADIO/release/radiocoind
    File /opt/CURRENTRADIO/release/radiocoin-cli
    SetOutPath $INSTDIR\doc
    File /r /opt/CURRENTRADIO/doc\*.*
    SetOutPath $INSTDIR
