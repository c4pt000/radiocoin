...
!define MUI_ICON "/opt/radiocoin/share/pixmaps/bitcoin.ico"
!define MUI_WELCOMEFINISHPAGE_BITMAP "/opt/radiocoin/share/pixmaps/nsis-wizard.bmp"
!define MUI_HEADERIMAGE
!define MUI_HEADERIMAGE_RIGHT
!define MUI_HEADERIMAGE_BITMAP "/opt/radiocoin/share/pixmaps/nsis-header.bmp"
...
!define MUI_UNWELCOMEFINISHPAGE_BITMAP "/opt/radiocoin/share/pixmaps/nsis-wizard.bmp"
...
OutFile /opt/radiocoin/radiocoin-${VERSION}-win-setup.exe
!if "" == "64"
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    File /opt/radiocoin/release/radiocoin-qt
    File /oname=COPYING.txt /opt/radiocoin/COPYING
    File /oname=readme.txt /opt/radiocoin/doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File /opt/radiocoin/release/radiocoind
    File /opt/radiocoin/release/radiocoin-cli
    SetOutPath $INSTDIR\doc
    File /r /opt/radiocoin/doc\*.*
    SetOutPath $INSTDIR
