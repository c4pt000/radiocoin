# Support for Output Descriptors in RadioCoin Core

Since RadioCoin Core v0.17, there is support for Output Descriptors. This is a
...
on RadioCoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing RadioCoin Core wallets, a convenience function `combo` is
