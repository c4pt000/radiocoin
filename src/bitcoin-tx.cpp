...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " radiocoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  radiocoin-tx [options] <hex-tx> [commands]  Update hex-encoded radiocoin transaction\n" +
            "or:     radiocoin-tx [options] -create [commands]   Create hex-encoded radiocoin transaction\n" +
            "\n";
