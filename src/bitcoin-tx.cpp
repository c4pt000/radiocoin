...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s radiocoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  radiocoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded radiocoin transaction") + "\n" +
              "  radiocoin-tx [options] -create [commands]   " + _("Create hex-encoded radiocoin transaction") + "\n" +
              "\n";
