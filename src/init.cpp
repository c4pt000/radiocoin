...
void Shutdown()
{
    ...
    StopHTTPServer();
#ifdef ENABLE_WALLET
    // Radiocoin 1.14 TODO: ShutdownRPCMining();
    if (pwalletMain)
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // ********************************************************* Step 5: verify radiocoin-wallet.database integrity
#ifdef ENABLE_WALLET
    if (!CWallet::Verify())
        return false;
#endif
    ...
    // Radiocoin: Do we need to do any RPC mining init here?
