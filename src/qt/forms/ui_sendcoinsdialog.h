...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        labelCoinControlAmount->setText(QString::fromUtf8("0.00 RADC"));
        ...
        labelCoinControlFee->setText(QString::fromUtf8("0.00 RADC"));
        ...
        labelCoinControlAfterFee->setText(QString::fromUtf8("0.00 RADC"));
        ...
        labelCoinControlChange->setText(QString::fromUtf8("0.00 RADC"));
        ...
        labelBalance->setText(QString::fromUtf8("123.456 RADC"));
...
#if QT_CONFIG(tooltip)
        labelCustomFeeWarning->setToolTip(QCoreApplication::translate("SendCoinsDialog", "When there is less transaction volume than space in the blocks, miners as well as relaying nodes may enforce a minimum fee. Paying only this minimum fee is just fine, but be aware that this can result in a never confirming transaction once there is more demand for radiocoin transactions than the network can process.", nullptr));
#endif // QT_CONFIG(tooltip)
