...
void PaymentServerTests::paymentServerTests()
{
    ...
    // Radiocoin: Disable certificate tests as we don't touch this code, and building test
    ...
    /* PL: This doesn't work for Radiocoin (as there is no actual maximum coins)
