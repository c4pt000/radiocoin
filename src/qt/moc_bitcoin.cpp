...
void BitcoinCore::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<BitcoinCore *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (BitcoinCore::*)(bool );
        ...
        {
            using _t = void (BitcoinCore::*)(const QString & );
...
QT_INIT_METAOBJECT const QMetaObject BitcoinCore::staticMetaObject = { {
    ...
    qt_meta_stringdata_BitcoinCore.data,
    qt_meta_data_BitcoinCore,
    qt_static_metacall,
    nullptr,
    nullptr
} };
